...
const Banner = () => {
  return (
    <div className="z-0">
      ...
      >
        <SwiperSlide>
          <img src={appDev} alt="" className="w-full max-h-[500px] " />
        </SwiperSlide>
        <SwiperSlide>
          <img src={webDev} alt="" className="w-full max-h-[500px]" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={desktopDev} alt="" className="w-full max-h-[500px]" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={graphicDeg} alt="" className="w-full max-h-[500px]" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={SEORank} alt="" className="w-full max-h-[500px]" />
        </SwiperSlide>
      </Swiper>
    </div>
  );
